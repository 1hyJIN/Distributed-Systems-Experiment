...
| ----------- | -------------- | -------------- | ------------- | ------------- | ------------ |
| 1           | 8.01s（舍去）  | 3.95s          | 2.17s         | 1.79s         | 2.91s        |
| 2           | 3.24s          | 3.28s          | 2.13s         | 1.69s         | 2.97s        |
| 3           | 3.16s          | 2.97s          | 2.10s         | 1.79s         | 2.76s        |
| 4           | 3.00s          | 3.42s          | 2.24s         | 1.74s         | 2.80s        |
| 5           | 3.16s          | 2.91s          | 2.20s         | 1.84s         | 2.83s        |
...
| Experiment  | 256 Partitions | 128 Partitions | 64 Partitions | 16 Partitions | 4 Partitions |
| ----------- | -------------- | -------------- | ------------- | ------------- | ------------ |
| 1           | 1.68s          | 1.88s          | 0.69s         | 0.34s         | 0.45s        |
| 2           | 1.44s          | 1.57s          | 0.84s         | 0.35s         | 0.43s        |
| 3           | 1.73s          | 1.65s          | 0.76s         | 0.39s         | 0.44s        |
| 4           | 1.56s          | 1.66s          | 0.78s         | 0.35s         | 0.43s        |
| 5           | 1.60s          | 1.69s          | 0.90s         | 0.35s         | 0.43s        |
